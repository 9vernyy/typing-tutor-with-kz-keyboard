...
uses
  ...
  Dialogs, jpeg, ExtCtrls, Grids, DBGrids, StdCtrls, Mask, DBCtrls;
...
type
  TPrivetWindow = class(TForm)
    ...
    SaveButton02: TImage;
    SaveButton3: TImage;
    DontSaveButton1: TImage;
    DontSaveButton01: TImage;
    DontSaveButton2: TImage;
    ...
    procedure ZapuskBut1MouseMove(Sender: TObject; Shift: TShiftState; X,
      Y: Integer);
    procedure ZapuskBut2MouseMove(Sender: TObject; Shift: TShiftState; X,
      Y: Integer);
    procedure ZapuskBut3MouseMove(Sender: TObject; Shift: TShiftState; X,
      Y: Integer);
    ...
    procedure YesDeleteButton02MouseDown(Sender: TObject;
      Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure YesDeleteButton1MouseMove(Sender: TObject;
      Shift: TShiftState; X, Y: Integer);
    procedure YesDeleteButton2MouseMove(Sender: TObject;
      Shift: TShiftState; X, Y: Integer);
    procedure YesDeleteButton3MouseMove(Sender: TObject;
      Shift: TShiftState; X, Y: Integer);
    ...
    procedure NoDeleteButton02MouseDown(Sender: TObject;
      Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure NoDeleteButton1MouseMove(Sender: TObject; Shift: TShiftState;
      X, Y: Integer);
    procedure NoDeleteButton2MouseMove(Sender: TObject; Shift: TShiftState;
      X, Y: Integer);
    procedure NoDeleteButton3MouseMove(Sender: TObject; Shift: TShiftState;
      X, Y: Integer);
    ...
    procedure CreateNewUsBut02MouseDown(Sender: TObject;
      Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure CreateNewUsBut1MouseMove(Sender: TObject; Shift: TShiftState;
      X, Y: Integer);
    procedure CreateNewUsBut2MouseMove(Sender: TObject; Shift: TShiftState;
      X, Y: Integer);
    procedure CreateNewUsBut3MouseMove(Sender: TObject; Shift: TShiftState;
      X, Y: Integer);
    ...
    procedure CancelCrNewUs02MouseDown(Sender: TObject;
      Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure CancelCrNewUs1MouseMove(Sender: TObject; Shift: TShiftState;
      X, Y: Integer);
    procedure CancelCrNewUs2MouseMove(Sender: TObject; Shift: TShiftState;
      X, Y: Integer);
    procedure CancelCrNewUs3MouseMove(Sender: TObject; Shift: TShiftState;
      X, Y: Integer);
    ...
    procedure SaveButton02MouseDown(Sender: TObject; Button: TMouseButton;
      Shift: TShiftState; X, Y: Integer);
    procedure SaveButton1MouseMove(Sender: TObject; Shift: TShiftState; X,
      Y: Integer);
    procedure SaveButton2MouseMove(Sender: TObject; Shift: TShiftState; X,
      Y: Integer);
    procedure SaveButton3MouseMove(Sender: TObject; Shift: TShiftState; X,
      Y: Integer);
    procedure DontSaveButton01MouseMove(Sender: TObject;
      Shift: TShiftState; X, Y: Integer);
    procedure DontSaveButton02MouseDown(Sender: TObject;
      Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
    procedure DontSaveButton1MouseMove(Sender: TObject; Shift: TShiftState;
      X, Y: Integer);
    procedure DontSaveButton2MouseMove(Sender: TObject; Shift: TShiftState;
      X, Y: Integer);
    procedure DontSaveButton3MouseMove(Sender: TObject; Shift: TShiftState;
      X, Y: Integer);
    ...
    procedure EnterButton02MouseDown(Sender: TObject; Button: TMouseButton;
      Shift: TShiftState; X, Y: Integer);
    procedure EnterButton1MouseMove(Sender: TObject; Shift: TShiftState; X,
      Y: Integer);
    procedure EnterButton2MouseMove(Sender: TObject; Shift: TShiftState; X,
      Y: Integer);
    procedure EnterButton3MouseMove(Sender: TObject; Shift: TShiftState; X,
      Y: Integer);
...
procedure TPrivetWindow.ZapuskBut1MouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
...
procedure TPrivetWindow.ZapuskBut2MouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
ZapuskBut02.Visible:=false;
ZapuskBut2.Visible:=false;
end;

procedure TPrivetWindow.ZapuskBut3MouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
ZapuskBut3.Visible:=False;
end;
...
with Canvas.Font do // »менно так, а не пpосто Font!
begin
Name := 'Courier New';
Size := 14;
end;
...
IF  gdSelected   IN State
	Then Begin
			TDBGrid(Sender).Canvas.Brush.Color:= RGB(226,192,189);;
...
procedure TPrivetWindow.YesDeleteButton1MouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
...
procedure TPrivetWindow.YesDeleteButton2MouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
YesDeleteButton02.Visible:=false;
YesDeleteButton2.Visible:=false;
end;

procedure TPrivetWindow.YesDeleteButton3MouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
YesDeleteButton3.Visible:=False;
end;
...
procedure TPrivetWindow.NoDeleteButton1MouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
NoDeleteButton02.Visible:=False;
NoDeleteButton3.Visible:=False;
...
procedure TPrivetWindow.NoDeleteButton2MouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
NoDeleteButton02.Visible:=false;
NoDeleteButton2.Visible:=false;
...
procedure TPrivetWindow.NoDeleteButton3MouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
NoDeleteButton3.Visible:=False;
end;
...
procedure TPrivetWindow.CreateNewUsBut1MouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
...
procedure TPrivetWindow.CreateNewUsBut2MouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
CreateNewUsBut02.Visible:=false;
CreateNewUsBut2.Visible:=false;
end;

procedure TPrivetWindow.CreateNewUsBut3MouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
CreateNewUsBut3.Visible:=False;
end;
...
procedure TPrivetWindow.CancelCrNewUs1MouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
CancelCrNewUs02.Visible:=False;
CancelCrNewUs3.Visible:=False;
...
procedure TPrivetWindow.CancelCrNewUs2MouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
CancelCrNewUs02.Visible:=false;
CancelCrNewUs2.Visible:=false;
...
procedure TPrivetWindow.CancelCrNewUs3MouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
CancelCrNewUs3.Visible:=False;
end;
...
procedure TPrivetWindow.SaveButton1MouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
SaveButton02.Visible:=False;
SaveButton3.Visible:=False;
...
procedure TPrivetWindow.SaveButton2MouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
SaveButton02.Visible:=false;
SaveButton2.Visible:=false;
...
procedure TPrivetWindow.SaveButton3MouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
SaveButton3.Visible:=False;
end;
...
procedure TPrivetWindow.DontSaveButton1MouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
DontSaveButton02.Visible:=False;
DontSaveButton3.Visible:=False;
...
procedure TPrivetWindow.DontSaveButton2MouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
DontSaveButton02.Visible:=false;
DontSaveButton2.Visible:=false;
...
procedure TPrivetWindow.DontSaveButton3MouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
DontSaveButton3.Visible:=False;
end;
...
procedure TPrivetWindow.EnterButton1MouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
EnterButton02.Visible:=False;
EnterButton3.Visible:=False;
...
procedure TPrivetWindow.EnterButton2MouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
EnterButton02.Visible:=false;
EnterButton2.Visible:=false;
...
procedure TPrivetWindow.EnterButton3MouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
EnterButton3.Visible:=False;
end;
...
lacasombra.Show;
lacasombra.labFIOUser.Caption:=FIO;
lacasombra.labFIOUserOnPanPech.Caption:=FIO;
end;
